...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        GameConstants consts = new GameConstants(0, 0, 20, 10, 15, 3, Color.WHITE, new Font("Verdana", 30));
...
//        GameConstants consts14 = new GameConstants(1200, 400, 20, 10, 15, 3, Color.WHITE);
        new Game(consts, new ControlScheme(KeyCode.S, KeyCode.A, KeyCode.D, KeyCode.W, KeyCode.SPACE));
